...
namespace Identity.Dapper.Tests.Queries.PostgreSQL
{
    public class PostgreSqlUserQueriesTests
    {
        ...
        public void GetUserLoginByLoginProviderAndProviderKeyQueryGeneratesCorrectQuery()
        {
            ...
            const string expected = "SELECT \"IdentityUser\".\"AccessFailedCount\", \"IdentityUser\".\"Email\", \"IdentityUser\".\"EmailConfirmed\", \"IdentityUser\".\"LockoutEnabled\", \"IdentityUser\".\"LockoutEnd\", \"IdentityUser\".\"PasswordHash\", \"IdentityUser\".\"PhoneNumber\", \"IdentityUser\".\"PhoneNumberConfirmed\", \"IdentityUser\".\"SecurityStamp\", \"IdentityUser\".\"TwoFactorEnabled\", \"IdentityUser\".\"UserName\", \"dbo\".\"IdentityUserRole\".* FROM \"dbo\".\"IdentityUser\" LEFT JOIN \"dbo\".\"IdentityUserRole\" ON \"dbo\".\"IdentityUserRole\".\"UserId\" = \"dbo\".\"IdentityUser\".\"Id\" INNER JOIN \"dbo\".\"IdentityLogin\" ON \"dbo\".\"IdentityUser\".\"Id\" = \"dbo\".\"IdentityLogin\".\"UserId\" WHERE \"LoginProvider\" = @LoginProvider AND \"ProviderKey\" = @ProviderKey LIMIT 1";
        ...
        public void GetUserLoginByLoginProviderAndProviderKeyQueryGeneratesCorrectQueryWhenUsingCustomUser()
        {
            ...
            const string expected = "SELECT \"IdentityUser\".\"AccessFailedCount\", \"IdentityUser\".\"Dummy\", \"IdentityUser\".\"Email\", \"IdentityUser\".\"EmailConfirmed\", \"IdentityUser\".\"LockoutEnabled\", \"IdentityUser\".\"LockoutEnd\", \"IdentityUser\".\"PasswordHash\", \"IdentityUser\".\"PhoneNumber\", \"IdentityUser\".\"PhoneNumberConfirmed\", \"IdentityUser\".\"SecurityStamp\", \"IdentityUser\".\"TwoFactorEnabled\", \"IdentityUser\".\"UserName\", \"dbo\".\"IdentityUserRole\".* FROM \"dbo\".\"IdentityUser\" LEFT JOIN \"dbo\".\"IdentityUserRole\" ON \"dbo\".\"IdentityUserRole\".\"UserId\" = \"dbo\".\"IdentityUser\".\"Id\" INNER JOIN \"dbo\".\"IdentityLogin\" ON \"dbo\".\"IdentityUser\".\"Id\" = \"dbo\".\"IdentityLogin\".\"UserId\" WHERE \"LoginProvider\" = @LoginProvider AND \"ProviderKey\" = @ProviderKey LIMIT 1";
