...
namespace Identity.Dapper.Tests.Queries.SQLServer
{
    public class SqlServerUserQueriesTests
    {
        ...
        public void GetUserLoginByLoginProviderAndProviderKeyQueryGeneratesCorrectQuery()
        {
            ...
            const string expected = "SELECT TOP 1 [IdentityUser].[AccessFailedCount], [IdentityUser].[Email], [IdentityUser].[EmailConfirmed], [IdentityUser].[LockoutEnabled], [IdentityUser].[LockoutEnd], [IdentityUser].[PasswordHash], [IdentityUser].[PhoneNumber], [IdentityUser].[PhoneNumberConfirmed], [IdentityUser].[SecurityStamp], [IdentityUser].[TwoFactorEnabled], [IdentityUser].[UserName], [dbo].[IdentityUserRole].* FROM [dbo].[IdentityUser] LEFT JOIN [dbo].[IdentityUserRole] ON [dbo].[IdentityUserRole].[UserId] = [dbo].[IdentityUser].[Id] INNER JOIN [dbo].[IdentityLogin] ON [dbo].[IdentityUser].[Id] = [dbo].[IdentityLogin].[UserId] WHERE [LoginProvider] = @LoginProvider AND [ProviderKey] = @ProviderKey";
        ...
        public void GetUserLoginByLoginProviderAndProviderKeyQueryGeneratesCorrectQueryWhenUsingCustomUser()
        {
            ...
            const string expected = "SELECT TOP 1 [IdentityUser].[AccessFailedCount], [IdentityUser].[Dummy], [IdentityUser].[Email], [IdentityUser].[EmailConfirmed], [IdentityUser].[LockoutEnabled], [IdentityUser].[LockoutEnd], [IdentityUser].[PasswordHash], [IdentityUser].[PhoneNumber], [IdentityUser].[PhoneNumberConfirmed], [IdentityUser].[SecurityStamp], [IdentityUser].[TwoFactorEnabled], [IdentityUser].[UserName], [dbo].[IdentityUserRole].* FROM [dbo].[IdentityUser] LEFT JOIN [dbo].[IdentityUserRole] ON [dbo].[IdentityUserRole].[UserId] = [dbo].[IdentityUser].[Id] INNER JOIN [dbo].[IdentityLogin] ON [dbo].[IdentityUser].[Id] = [dbo].[IdentityLogin].[UserId] WHERE [LoginProvider] = @LoginProvider AND [ProviderKey] = @ProviderKey";
